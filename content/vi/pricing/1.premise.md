...
::pricing-table
  ::table-row{noBorder feat}
    ...
    ::table-col{noBg}
    ::button-link{href="/cart?product=Gói Free&price=390000" rounded size=default white}
    Thêm vào giỏ hàng
    ::
    ::

    ::table-col{noBg}
    ::button-link{href="/cart?product=Gói Pro&price=490000" rounded size=default white}
    Thêm vào giỏ hàng
    ::
    ::

    ::table-col{noBg}
    ::button-link{href="/cart?product=Gói Enterprise&price=590000" rounded size=default white}
    Thêm vào giỏ hàng
    ::
    ::
  ::
