...
<template>
  <div class="mt-12 flex items-center first:mt-0 space-x-4" :class="small && 'mt-10px! gap-2!'">
    <div v-if="$slots.image" class="relative mt-1 size-70px flex-center flex-shrink-0">
    ...
    <div>
      <h4 class="text-xl text-gray-800 font-medium dark:text-gray-200" :class="small && 'text-base!'">
