...
<template>
  <div class="sticky top-0 z-10 h-$header-height w-full bg-white shadow print:hidden" dark="bg-trueGray-900">
    ...
    >
      <div class="flex flex-shrink-0 flex-wrap items-center justify-between lg:w-auto">
    ...
    <NuxtLink class="invisible hidden" :to="localePath('/pricing/premise')" />
    <NuxtLink class="invisible hidden" :to="localePath('/pricing/cloud')" />
  </div>
</template>
