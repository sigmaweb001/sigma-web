...
useHead({
  link: [
    { rel: 'alternate', type: 'application/rss+xml', title: 'SigmaStreaming Changelog', href: '/changelog/feed.xml' },
  ],
})
useSeoMeta({
  title: page.title,
...
<template>
  <UContainer>
    ...
    <div class="relative">
      <div
        ref="dot"
        class="hidden lg:block absolute w-[2px] rounded-full bg-gray-500 dark:bg-gray-400 z-10 neon dot"
      ...
      <ul class="flex flex-col">
        <li
          v-for="(changelog, index) in posts"
          :key="changelog.title"
        ...
        >
          ...
          >
            <div
              ref="dots"
              class="hidden lg:block left-4 top-24 h-2 w-2 rounded-full bg-gray-500 dark:bg-gray-400 z-10"
              :class="{ neon: index === 0 }"
            />
          ...
          <div class="w-full mb-32 relative">
            <div class="space-y-4 -mt-1">
              <NuxtLink
                ...
                class="inline-block overflow-hidden rounded-md border dark:border-gray-800 border-gray-200"
              >
                <img
                  :alt="changelog.title || ''"
                  loading="lazy"
              ...
              <div class="flex flex-col">
                ...
                <div class="mt-4 flex flex-wrap items-center gap-6">
                  <UButton
                    v-for="author in changelog.authors"
                    :key="author.username"
                    :to="author.to"
                    target="_blank"
                    color="neutral"
