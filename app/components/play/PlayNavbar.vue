...
<template>
  <div
    class="sticky top-0 z-10 h-$header-height w-full bg-white shadow print:hidden"
        ...
        >
          ...
          <div class="hidden lg:block">
            ...
            <div class="flex items-center gap-0.75">
              <span class="h-1.5 w-1.5 animate-ping rounded-full bg-(--ui-primary)" />
              <span
                class="text-[14px/19px] font-600 tracking-widest"
                lg="inline-block"
              >Streaming</span>
            </div>
          </div>
