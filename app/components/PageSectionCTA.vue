...
<template>
  <UPageSection
    ...
    :links="[
      ...
      {
        label: 'Read the products',
        to: '/products/getting-started',
        variant: 'ghost',
        color: 'neutral',
      },
    ]"
  >
    <svg
      class="absolute top-0 inset-x-0 pointer-events-none"
    ...
    <template #title>
      <span>Start with SigmaStreaming <span class="text-(--ui-primary)">today</span></span>
    </template>
  </UPageSection>
</template>
