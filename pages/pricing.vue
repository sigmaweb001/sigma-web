    ...
    <div class="relative">
      <ContentRenderer :value="pricing">
        ...
        <div class="absolute bottom-0 left-1/2 flex translate-x--1/2">
          ...
          >
            <div class="min-h-65px min-w-300px flex flex-col cursor-pointer items-center justify-center rounded-t-40px bg-gray-400 group-[.router-link-active]:bg-white">
